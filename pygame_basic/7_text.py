...
character_height = character_size[1] # 캐리거의 세로 크기
...
# 적 enemy 캐릭터
# 캐릭터(스프라이트) 불러오기
enemy = pygame.image.load("C:\\Users\\차윤범\\Desktop\\Advanced_Python\\pygame_basic\\enemy.png")
enemy_size = enemy.get_rect().size # 이미지의 크기를 구해옴
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐리거의 세로 크기
...
# 20 fps : 1초 동안에 20번 동작 -> 1번에 5만큼! 5 * 20 = 100
    ...
    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255,255,255)) # 출력할 글자(시간정보), True, 글자 색상
